...
expectContains('index.html', `css/app.css?v=${compact}`, `css/institute.css?v=${compact}`, `js/app.js?v=${compact}`, `js/register-sw.js?v=${compact}`);
expectContains('js/register-sw.js', `sw.js?v=${compact}`);
