...
<p>{{redflag:“Guaranteed monthly bot profit — API key please” = theft/scam pattern.}}</p>`,
    ...
    quiz: [
      { q: { en: 'Trading bots mainly:', ur: 'Trading bots mainly kya karte hain:' },
        opts: { en: ['Execute rules you (or a vendor) defined', 'Guarantee alpha', 'Delete liquidation'], ur: ['Tum ne (ya vendor ne) define kiye rules execute karte hain', 'Guarantee alpha', 'Delete liq'] },
        correct: 0, explain: { en: 'Rules in, risk remains.', ur: 'Rules andar hain — risk ab bhi rehta hai.' } },
      { q: { en: 'Sharing withdraw API keys is:', ur: 'Withdraw API keys share karna kya hai:' },
      ...
      { q: { en: '“Guaranteed bot income” is:', ur: '“Guaranteed bot income” kya hai:' },
      ...
      { q: { en: 'This elective teaches:', ur: 'Ye elective kya sikhati hai:' },
        opts: { en: ['Defense literacy — not endorsement', 'How to get rich weekly', 'Broker license'], ur: ['Defense literacy hai — endorsement nahi hai ye track', 'Get rich', 'License'] },
  ...
  week({
    ...
    quiz: [
      { q: { en: 'Grid bots struggle most in:', ur: 'Grid bots sab se zyada kahan struggle karte hain:' },
      ...
      { q: { en: 'Copy trading risk includes:', ur: 'Copy trading risk mein kya shamil hai:' },
        opts: { en: ['Mismatched sizing and hidden conflicts', 'Guaranteed matching fills', 'No latency'], ur: ['Mismatched sizing aur chhupi conflicts ho sakti hain', 'Guaranteed fills', 'No latency'] },
        correct: 0, explain: { en: 'Not your book.', ur: 'Not your book.' } },
      { q: { en: 'Unbounded DCA into a crash:', ur: 'Crash mein unbounded DCA kya hai:' },
      ...
      { q: { en: 'Before any bot deposit set:', ur: 'Kisi bhi bot deposit se pehle kya set karo:' },
...
<p>{{redflag:Pay to unlock “VIP bot settings” after a loss = second trap.}}</p>`,
    ...
    quiz: [
      ...
      { q: { en: 'Paying unlock fees after a bot loss is:', ur: 'Bot loss ke baad unlock fees dena kya hai:' },
        opts: { en: ['A common second scam', 'Required recovery', 'SECP process'], ur: ['Second scam', 'Recovery', 'SECP'] },
        correct: 0, explain: { en: 'Refuse.', ur: 'Refuse.' } },
      { q: { en: 'Signal groups often omit:', ur: 'Signal groups aksar kya omit karti hain:' },
      ...
      { q: { en: 'Best stance on paid gurus:', ur: 'Paid gurus pe behtar stance kya hai:' },
        opts: { en: ['Skeptical — verify process yourself', 'Blind trust', 'Share all keys'], ur: ['Skeptical raho — process khud verify karo hamesha', 'Blind trust', 'Share keys'] },
