...
<p>{{redflag:“90% win binary signals” = classic scam bait.}}</p>`,
    ...
    quiz: [
      ...
      { q: { en: '“90% win binary signals” is:', ur: '“90% win binary signals” kya hai:' },
        opts: { en: ['Scam bait', 'Normal research', 'Risk-free'], ur: ['Scam bait', 'Research', 'Risk-free'] },
        correct: 0, explain: { en: 'Refuse.', ur: 'Refuse.' } },
      { q: { en: 'Binary short-timer bets resemble:', ur: 'Binary short-timer bets kis se resemble karte hain:' },
      ...
      { q: { en: 'Completing this track means:', ur: 'Is track ko complete karna kya matlab hai:' },
        opts: { en: ['You studied risks — not endorsed trading', 'You may market binaries', 'Income unlocked'], ur: ['Tum ne risks study kiye — trading endorsed nahi hai', 'Market binaries', 'Income'] },
  ...
  week({
    ...
    quiz: [
      { q: { en: 'Paying 100 to win 80 on fair coin-ish odds is:', ur: 'Fair coin-ish odds pe 100 de kar 80 jeetna kya hai:' },
        opts: { en: ['Negative EV', 'Positive EV always', 'Risk-free'], ur: ['Negative EV', 'Positive EV', 'Risk-free'] },
        correct: 0, explain: { en: 'Math.', ur: 'Math.' } },
      { q: { en: 'Martingale after binary losses:', ur: 'Binary losses ke baad Martingale kya hai:' },
      ...
      { q: { en: 'Best use of this math is:', ur: 'Is math ka behtar use kya hai:' },
...
<p>If withdrawals fail — stop funding immediately.</p>`,
    ...
    quiz: [
      { q: { en: 'Pay tax/fee to unlock withdrawal is:', ur: 'Withdrawal unlock ke liye tax/fee dena kya hai:' },
        opts: { en: ['A scam pattern', 'Normal banking always', 'Required by all regulators'], ur: ['Scam', 'Normal', 'Required'] },
        correct: 0, explain: { en: 'Refuse.', ur: 'Refuse.' } },
      { q: { en: 'After blocked withdrawals you should:', ur: 'Blocked withdrawals ke baad tumhein kya karna chahiye:' },
      ...
      { q: { en: 'Recovery DMs after binary loss are often:', ur: 'Binary loss ke baad recovery DMs aksar kya hote hain:' },
        opts: { en: ['Second scams', 'Police process', 'Insurance'], ur: ['Second scam', 'Police', 'Insurance'] },
        correct: 0, explain: { en: 'Refuse.', ur: 'Refuse.' } },
      { q: { en: 'Cold-call deposit ladders are:', ur: 'Cold-call deposit ladders kya hain:' },
...
<p>No martingale. No “revenge one more.” Certificate = harm study — playbook nahi.</p>`,
    ...
    quiz: [
      { q: { en: 'Preferred stance on binaries:', ur: 'Binaries pe preferred stance kya hai:' },
      ...
      { q: { en: 'If already deposited and blocked:', ur: 'Agar pehle se deposit ho aur block ho to:' },
        opts: { en: ['Stop funding; document; legit channels', 'Pay unlock fees', 'Hire recovery DM'], ur: ['Funding band karo; document karo; legit channels use karo', 'Unlock fee', 'Recovery DM'] },
