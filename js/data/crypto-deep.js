...
<p>{{redflag:Seed mange = attack.}}</p>`,
    ...
    quiz: [
      { q: { en: 'An exchange balance is best thought of as:', ur: 'Exchange balance ko behtar taur pe kya samjhte hain:' },
        ...
        correct: 0, explain: { en: 'Venue controls the keys until you withdraw.', ur: 'Withdraw tak venue keys control karti hai.' } },
      { q: { en: 'If you share your seed phrase:', ur: 'Agar tum apni seed phrase share karo to:' },
        opts: { en: ['The other party can take the funds', 'Nothing happens', 'Only viewing rights'], ur: ['Doosra party funds le sakta hai tumhari', 'Kuch nahi', 'Sirf view'] },
        correct: 0, explain: { en: 'Seed = full control.', ur: 'Seed = control.' } },
      { q: { en: 'Best first custody habit:', ur: 'Custody ki pehli behtar habit kya hai:' },
        opts: { en: ['Test small withdrawal before large balances', 'Disable 2FA for speed', 'Email seed to yourself in plain text'], ur: ['Bari balance se pehle chhota withdrawal test karo', '2FA off', 'Seed ko plain text mein apne aap ko email karna'] },
        correct: 0, explain: { en: 'Withdrawals prove exit.', ur: 'Withdrawals exit prove karte hain.' } },
      { q: { en: 'Hardware wallets mainly help against:', ur: 'Hardware wallets mainly kis cheez se madad karte hain:' },
        opts: { en: ['Remote malware stealing hot keys — if used correctly', 'All market risk', 'Guaranteed profits'], ur: ['Remote malware hot keys chura sakta hai — sahi use pe', 'Market risk', 'Profits'] },
...
<p>“Chhota” scalp fee-negative ho sakta. Size se pehle round-trip cost vs edge compare karo.</p>`,
    ...
    quiz: [
      { q: { en: 'Crossing the spread means you typically:', ur: 'Spread cross karne ka matlab aksar tum:' },
        opts: { en: ['Pay a transaction cost baked into the quote', 'Earn the spread as rebate always', 'Avoid all fees'], ur: ['Quote mein shamil transaction cost pay karna parta hai', 'Hamesha spread ko rebate ke taur pe kamana', 'No fees'] },
        correct: 0, explain: { en: 'Urgency pays the spread.', ur: 'Jaldi = spread.' } },
      { q: { en: 'Slippage is more likely when:', ur: 'Slippage zyada kab mumkin hoti hai jab:' },
        opts: { en: ['Liquidity is thin or size is large vs the book', 'You use a limit that rests', 'Fees are zero'], ur: ['Liquidity patli ho ya size book se bari ho to slippage', 'Resting limit', 'Zero fees'] },
        correct: 0, explain: { en: 'Thin books move against marketable size.', ur: 'Thin books marketable size ke khilaf move karti hain.' } },
      { q: { en: 'Before calling a scalp profitable you should:', ur: 'Scalp ko profitable kehne se pehle tumhein kya karna chahiye:' },
        opts: { en: ['Compare target move to round-trip costs', 'Ignore fees if confident', 'Only check Twitter'], ur: ['Target move ko round-trip costs se compare karo', 'Fees ignore', 'Twitter'] },
        correct: 0, explain: { en: 'Costs first.', ur: 'Costs pehle.' } },
      { q: { en: 'Funding rates matter most for:', ur: 'Funding rates sab se zyada kis ke liye matter karte hain:' },
        opts: { en: ['Holding perpetual futures across funding times', 'Spot HODL only', 'Bank savings accounts'], ur: ['Perpetual futures funding times ke dauran hold karna', 'Spot HODL', 'Bank'] },
        correct: 0, explain: { en: 'Funding is a perp mechanic.', ur: 'Funding ek perp mechanic hai.' } },
    ],
  }),
  week({
    id: 3,
...
<p>{{redflag:“Sure hun is liye 10×” — surety risk system nahi.}}</p>`,
    ...
    quiz: [
      { q: { en: 'Liquidation means:', ur: 'Liquidation:' },
        opts: { en: ['Forced close when margin is exhausted', 'A free bonus from the exchange', 'Guaranteed profit taking'], ur: ['Jab margin khatam ho to forced close ho jata hai', 'Bonus', 'Guaranteed profit'] },
        correct: 0, explain: { en: 'Margin gone → position closed.', ur: 'Margin khatam → position band ho jati hai.' } },
      { q: { en: 'Leverage is best treated as:', ur: 'Leverage ko behtar taur pe kya samjha jaye:' },
        opts: { en: ['Output of risk math', 'A personality flex', 'Always 100×'], ur: ['Risk math output', 'Flex', '100×'] },
        correct: 0, explain: { en: 'Stop + risk $ decide size.', ur: 'Stop + risk $ size decide karte hain.' } },
      { q: { en: 'Calmer beginner path is usually:', ur: 'Calmer beginner path aksar kya hota hai:' },
      ...
      { q: { en: '“10× because sure” is:', ur: '“10× because sure” kya hai:' },
...
<p>Rules: URL verify, jaldi mat karo, unknown spender approve mat karo, seed share mat karo, DM ko proved hone tak hostile samjho.</p>`,
    ...
    quiz: [
      { q: { en: 'A DM claiming “exchange support” asks for seed. You:', ur: 'DM “exchange support” keh kar seed maangta. Tum:' },
        ...
        correct: 0, explain: { en: 'Support never needs seeds.', ur: 'Support ko seed kabhi nahi chahiye hoti.' } },
      { q: { en: 'Unknown airdrop “verify” prompts are dangerous because:', ur: 'Unknown airdrop “verify” prompts khatarnak kyun hain:' },
        opts: { en: ['They may request draining approvals', 'They always pay guaranteed yield', 'They are required by law'], ur: ['Wo draining approvals maang sakte hain tum se', 'Wo hamesha guaranteed yield dete hain kehte hain', 'Law'] },
        correct: 0, explain: { en: 'Blind approvals drain.', ur: 'Blind approvals se funds drain ho sakte hain.' } },
      { q: { en: 'After a loss, a recovery agent asks for more crypto. Likely:', ur: 'Loss ke baad recovery agent aur crypto maangta. Likely:' },
        opts: { en: ['A second scam', 'Official police process', 'Required insurance'], ur: ['Second scam', 'Police', 'Insurance'] },
        correct: 0, explain: { en: 'Recovery scams target victims twice.', ur: 'Recovery scams victims ko do baar target karte hain.' } },
      { q: { en: 'Best URL habit:', ur: 'URL:' },
        opts: { en: ['Type/bookmark official domains; distrust ads', 'Always click first ad', 'Trust any https lock'], ur: ['Official domains type/bookmark karo; ads pe trust mat karo', 'First ad', 'Any https'] },
...
<p>Chart toys baad mein. Bina custody + risk + logs, charts decoration hain.</p>`,
    ...
    quiz: [
      ...
      { q: { en: 'Charts alone are insufficient because:', ur: 'Sirf charts kafi kyun nahi hain kyunki:' },
        opts: { en: ['Custody, risk, and costs still decide survival', 'Charts are illegal', 'Indicators always fail'], ur: ['Custody, risk aur costs ab bhi survival decide karte hain', 'Illegal', 'Always fail'] },
        correct: 0, explain: { en: 'Survival stack > shapes.', ur: 'Survival > shapes.' } },
      { q: { en: 'After this track you should unlock practice that is:', ur: 'Is track ke baad practice unlock karni chahiye jo:' },
