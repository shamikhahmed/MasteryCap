...
<p>Leverage is embedded via margin — efficiency with liquidation risk.</p>`,
    ...
    quiz: [
      { q: { en: 'Futures primarily are:', ur: 'Futures:' },
      ...
      { q: { en: 'Margin in futures mainly adds:', ur: 'Margin:' },
        opts: { en: ['Leverage and liquidation risk', 'Guaranteed yield', 'Zero risk'], ur: ['Lev + liq', 'Yield', 'Zero risk'] },
        correct: 0, explain: { en: 'Efficiency with teeth.', ur: 'Teeth.' } },
      { q: { en: 'Mark-to-market means:', ur: 'MTM:' },
        opts: { en: ['Daily P/L settlement vs the market', 'Never update price', 'Only yearly'], ur: ['Daily P/L', 'Never update', 'Yearly'] },
        correct: 0, explain: { en: 'Continuous settlement.', ur: 'Continuous.' } },
      { q: { en: 'This track promises:', ur: 'Promise:' },
        opts: { en: ['Contract literacy — not signal income', 'Weekly salary', 'Free fills'], ur: ['Literacy', 'Salary', 'Free fills'] },
...
<p>Sizing from “I can afford the margin” alone is how people over-lever.</p>`,
    ...
    quiz: [
      { q: { en: 'Notional vs margin:', ur: 'Notional:' },
      ...
      { q: { en: 'Ignoring tick value leads to:', ur: 'Ignore tick:' },
      ...
      { q: { en: '“I can post margin” alone means:', ur: 'Margin alone:' },
...
<p><strong>Roll</strong> before expiry if you want continuity. <strong>Contango/backwardation</strong> describe curve shape — costs/benefits for holders over time, not magic signals.</p>`,
    ...
    quiz: [
      { q: { en: 'Maintenance margin breach can lead to:', ur: 'Breach:' },
        opts: { en: ['Margin call / liquidation path', 'Free bonus', 'Guaranteed roll profit'], ur: ['Call / liq', 'Bonus', 'Roll profit'] },
        correct: 0, explain: { en: 'Venue protects itself.', ur: 'Venue.' } },
      { q: { en: 'Roll exists to:', ur: 'Roll:' },
        opts: { en: ['Continue exposure past near expiry', 'Delete all risk', 'Avoid all fees forever'], ur: ['Continue exposure', 'Delete risk', 'No fees'] },
        correct: 0, explain: { en: 'Continuity.', ur: 'Continuity.' } },
      { q: { en: 'Contango/backwardation are:', ur: 'Curve:' },
        opts: { en: ['Curve descriptions — not magic tips', 'Guaranteed salaries', 'Illegal'], ur: ['Curve descriptions', 'Salaries', 'Illegal'] },
        correct: 0, explain: { en: 'Shape literacy.', ur: 'Shape.' } },
      { q: { en: 'Hold to expiry without plan is:', ur: 'Expiry:' },
...
<p>Certificate = study record — not prop-desk license.</p>`,
    ...
    quiz: [
      ...
      { q: { en: 'This certificate means:', ur: 'Cert:' },
        ...
        correct: 0, explain: { en: 'Honesty.', ur: 'Honesty.' } },
      { q: { en: 'Roll/expiry plan belongs:', ur: 'Roll:' },
