...
<p>{{redflag:Exact tops/bottoms from one CPI thread = entertainment.}}</p>`,
    ...
    quiz: [
      { q: { en: 'Macro literacy mainly helps you:', ur: 'Macro literacy mainly tumhein kya madad deti hai:' },
        ...
        correct: 0, explain: { en: 'Backdrop informs size.', ur: 'Backdrop size inform karta hai.' } },
      { q: { en: 'Scalping every CB meeting is:', ur: 'Har CB meeting pe scalping kya hai:' },
      ...
      { q: { en: 'Best beginner use:', ur: 'Beginner ke liye behtar use kya hai:' },
        opts: { en: ['Risk-on/off sizing and horizon', 'All-in on one CPI', 'Ignore cash buffer'], ur: ['Sizing/horizon', 'CPI all-in', 'Ignore cash'] },
        correct: 0, explain: { en: 'Size over prediction.', ur: 'Prediction se zyada size matter karti hai.' } },
      { q: { en: 'This track promises:', ur: 'Is track ka kya wada hai:' },
        opts: { en: ['Frameworks — not income or mastery cert', 'Salary signals', 'Crystal ball'], ur: ['Frameworks hain — income ya mastery cert nahi hai', 'Salary', 'Crystal'] },
...
<p>Inflation prints = backdrop, same-day lottery nahi 20× ke saath.</p>`,
    ...
    quiz: [
      ...
      { q: { en: 'High inflation makes long-term pure cash:', ur: 'High inflation long-term pure cash ko kya banati hai:' },
      ...
      { q: { en: 'Before investing surplus keep:', ur: 'Surplus invest karne se pehle kya rakho:' },
      ...
      { q: { en: 'Inflation print as same-day 20× trade is:', ur: 'Inflation print ko same-day 20× trade samajhna kya hai:' },
...
<p>Local FX real economy rewrite karti (import costs, earnings mix). Strong USD aksar = tighter global conditions. Liquidity oxygen hai — jab patli ho, risk assets saans lete hain.</p>`,
    ...
    quiz: [
      ...
      { q: { en: '20× on one rate decision is:', ur: 'Ek rate decision pe 20× kya hai:' },
      ...
      { q: { en: 'Strong USD often coincides with:', ur: 'Strong USD aksar kis ke sath coincide karta hai:' },
        opts: { en: ['Tighter global financial conditions', 'Always PSX melt-up', 'Zero FX effect'], ur: ['Global financial conditions tight ho jati hain', 'PSX melt-up', 'Zero FX'] },
        correct: 0, explain: { en: 'Channel, not guarantee.', ur: 'Channel hai — guarantee nahi.' } },
    ],
  }),
  week({
    id: 4,
...
<p>Certificate = study record. Salary nahi. Crystal ball license nahi.</p>`,
    ...
    quiz: [
      { q: { en: 'Macro process starts with:', ur: 'Macro process kis se shuru hota hai:' },
      ...
      { q: { en: 'After this track you should:', ur: 'Is track ke baad tumhein kya karna chahiye:' },
        opts: { en: ['Log backdrop + adjust size calmly', 'All-in every print', 'Quit records'], ur: ['Backdrop log karo + size calmly adjust karo', 'All-in', 'Quit records'] },
