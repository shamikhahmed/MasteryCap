...
<p>{{redflag:“This course → passive salary” is fantasy.}}</p>`,
    ...
    quiz: [
      { q: { en: 'Retail’s structural edge is mainly:', ur: 'Edge:' },
        opts: { en: ['Time / patience asymmetry', 'Faster than institutions', 'Secret tips'], ur: ['Time', 'Faster', 'Tips'] },
        correct: 0, explain: { en: 'No redemption pressure if you hold.', ur: 'Hold capacity.' } },
      { q: { en: 'Relabeling a loser as long-term is:', ur: 'Relabel:' },
        opts: { en: ['A refused stop loss in costume', 'Valid pivot always', 'Diversification'], ur: ['Costume stop', 'Valid', 'Diversify'] },
        correct: 0, explain: { en: 'Decide game before entry.', ur: 'Pehle game.' } },
      { q: { en: 'Investing questions are answered by:', ur: 'Invest Q:' },
        opts: { en: ['Financial statements and business facts', 'Only candles', 'Only Telegram'], ur: ['Statements', 'Candles', 'Telegram'] },
        correct: 0, explain: { en: 'Business over years.', ur: 'Business.' } },
      { q: { en: 'This track promises:', ur: 'Promise:' },
        opts: { en: ['Evaluation literacy — not tips or income', 'Hot stock list', 'Guaranteed 15%'], ur: ['Literacy', 'Hot list', '15%'] },
...
<p><strong>Profit raye hai; cash haqeeqat.</strong> Saalon tak rising profit + shrinking operating cash bina finance degree ke red flag hai.</p>`,
    ...
    quiz: [
      { q: { en: '“Profit is opinion, cash is fact” means:', ur: 'Meaning:' },
        opts: { en: ['Earnings malleable; OCF harder to fake', 'Profits never lie', 'Cash irrelevant'], ur: ['Earnings malleable', 'Never lie', 'Cash irrelevant'] },
        correct: 0, explain: { en: 'Cash arrived or not.', ur: 'Cash aya ya nahi.' } },
      { q: { en: 'Years of rising profit + shrinking OCF:', ur: 'Pattern:' },
      ...
      { q: { en: 'Before buying, a minimum habit is:', ur: 'Habit:' },
      ...
      { q: { en: 'Cash flow statement mainly shows:', ur: 'CF:' },
...
<p>{{redflag:Unlicensed tips + “guaranteed IPO allotment” = scam theater.}}</p>`,
    ...
    quiz: [
      { q: { en: 'Informal funding channels mainly add:', ur: 'Informal:' },
      ...
      { q: { en: 'Fund expense ratios:', ur: 'ER:' },
      ...
      { q: { en: '“Guaranteed IPO allotment for a fee” is:', ur: 'IPO:' },
      ...
      { q: { en: 'Best first access habit:', ur: 'Access:' },
        opts: { en: ['Regulated broker + known fee schedule', 'Random tip group deposit', 'Max leverage day one'], ur: ['Regulated + fees', 'Tip group', 'Max lev'] },
...
<p>MasteryCap certificates self-issued study records hain — licenses, advice, income rights nahi.</p>`,
    ...
    quiz: [
      { q: { en: 'Sober investing practice starts with:', ur: 'Start:' },
      ...
      { q: { en: 'Tips replace:', ur: 'Tips:' },
        opts: { en: ['Nothing — still need your process', 'All filings forever', 'Risk math'], ur: ['Nothing', 'All filings', 'Risk math'] },
        correct: 0, explain: { en: 'Tips ≠ syllabus.', ur: 'Tips ≠ syllabus.' } },
      { q: { en: 'After this track practice should be:', ur: 'Practice:' },
