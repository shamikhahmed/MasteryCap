...
<p>{{redflag:“Tax-free forever scheme — deposit now” = scam theater.}}</p>`,
    ...
    quiz: [
      { q: { en: 'This app’s tax role is:', ur: 'Is app ka tax role kya hai:' },
      ...
      { q: { en: '“Tax-free forever, deposit now” is:', ur: '“Tax-free forever, deposit now” kya hai:' },
      ...
      { q: { en: 'Complex cross-border facts should go to:', ur: 'Complex cross-border facts kahan jane chahiye:' },
      ...
      { q: { en: 'Copying Discord into a return is:', ur: 'Discord ko return mein copy karna kya hai:' },
...
<p>Achhe records practitioner cost kam karte aur “I forgot” disasters se bachate. Bure records chhote gains ko mehngi reconstruction bana dete hain.</p>`,
    ...
    quiz: [
      { q: { en: 'Best records timing is:', ur: 'Records ka behtar timing kya hai:' },
      ...
      { q: { en: 'Broker statements help because:', ur: 'Broker statements kyun madad karte hain:' },
        opts: { en: ['They reconstruct activity for reviews/filings', 'They guarantee refunds', 'They replace laws'], ur: ['Reviews/filings ke liye activity reconstruct karte hain', 'Refunds', 'Replace laws'] },
        correct: 0, explain: { en: 'Evidence trail.', ur: 'Evidence.' } },
      { q: { en: 'Crypto CSV exports should be:', ur: 'Crypto CSV exports ko kya karna chahiye:' },
      ...
      { q: { en: 'Skipping records until year-end usually:', ur: 'Year-end tak records skip karna aksar:' },
...
<p>Foreign accounts fund karna legal banking channels se hona chahiye — applicable rules ke mutabiq. Informal channels legal risk add karte jo investment return se bada ho sakta hai.</p>`,
    ...
    quiz: [
      { q: { en: 'Foreign brokerage/crypto should trigger:', ur: 'Foreign brokerage/crypto ko kya trigger karna chahiye:' },
        opts: { en: ['Practitioner questions with your facts', 'Ignore forever', 'Only tip groups'], ur: ['Apne facts ke sath practitioner se sawal karo', 'Ignore', 'Tips'] },
        correct: 0, explain: { en: 'Facts + pro.', ur: 'Facts + pro.' } },
      { q: { en: '“Crypto is untaxable because digital” is:', ur: '“Crypto is untaxable because digital” kya hai:' },
      ...
      { q: { en: 'Informal funding channels:', ur: 'Informal funding channels kya hain:' },
      ...
      { q: { en: 'Best residency source is:', ur: 'Residency ka behtar source kya hai:' },
...
<p>Graduation: records habit + complex facts pe practitioner on call. Wealth path = clean paperwork — evasion fantasy nahi.</p>`,
    ...
    quiz: [
      { q: { en: 'A hire trigger includes:', ur: 'Hire trigger mein kya shamil hota hai:' },
        opts: { en: ['Foreign/crypto accounts or unclear residency', 'Having a phone', 'Watching one video'], ur: ['Foreign/crypto accounts ya unclear residency ho to', 'Phone', 'One video'] },
        correct: 0, explain: { en: 'Complexity threshold.', ur: 'Complexity threshold cross ho gaya.' } },
      { q: { en: 'Pay-to-unlock tax portal DMs are:', ur: 'Pay-to-unlock tax portal DMs kya hain:' },
