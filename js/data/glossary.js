...
export const GLOSSARY = [
  ...
  { term: 'Paper Process Readiness', en: 'A local record of process checks on paper/tiny size at issue time — not lifetime mastery, income, or a license. Skills decay.', ur: 'Issue waqt paper/tiny size process checks ka local record — lifetime mastery, income, ya license nahi. Skills kamzor hoti.', tracks: ['foundations'] },
  ...
  { term: 'Course study record', en: 'Self-issued local PNG after assessment — not a readiness record or external credential.', ur: 'Assessment ke baad khud jari local PNG — readiness record ya bahar credential nahi.', tracks: ['foundations'] },
